        ...
        $(function() {
            var dataTable = $('#datatable').DataTable({
                ...
                columns: [{data: 'DT_RowIndex',orderable: false,searchable: false},
                    {data: 'action',name: 'services.id',searchable: false },
                    {data: 'status',name: 'services.id',searchable: false},
                    {data: 'home_featured',name: 'services.home_featured'},
                    {data: 'index',name: 'services.index'},
                    {data: 'category_id',name: 'services.category_id'},
