                    ...
                    <div class="card-body border-top">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Personal E-Mail"
                                    name="personal_email" value="{{ isset($employee) ? $employee->personal_email : '' }}" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Employee ID" name="emp_id"
                                    value="{{ isset($employee) ? $employee->emp_id : $emp_id }}" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <input type="text" class="form-control" placeholder="Password" name="password"
                                    value="{{ isset($employee) ? $employee->user->text_password : '' }}" />
